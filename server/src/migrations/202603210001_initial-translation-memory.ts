...
export const initialTranslationMemoryMigration: SqlMigrationDefinition = {
  id: "202603210001_InitialTranslationMemory",
  productVersion: "1.0.0",
  name: "Initial translation memory schema",
  up: `
  ...
  `,
  down: `
    DROP TRIGGER IF EXISTS trg_translation_units_updated_at;
    DROP TRIGGER IF EXISTS trg_segments_updated_at;
    DROP INDEX IF EXISTS idx_translation_units_last_used;
    DROP INDEX IF EXISTS idx_translation_units_project_lookup;
    DROP INDEX IF EXISTS idx_translation_units_lookup;
    DROP INDEX IF EXISTS idx_translation_units_exact;
    DROP INDEX IF EXISTS idx_segment_tokens_segment;
    DROP INDEX IF EXISTS idx_segments_language_normalized;
    DROP INDEX IF EXISTS idx_segments_language_hash;
    DROP INDEX IF EXISTS idx_segments_document_position;
    DROP INDEX IF EXISTS idx_documents_project;
    DROP TABLE IF EXISTS translation_units;
    DROP TABLE IF EXISTS segment_tokens;
